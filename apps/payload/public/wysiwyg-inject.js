(function() {
  function initWysiwyg() {
    ...
    blocks.forEach(function(blk) {
      ...
      item.onclick = function(e) { e.preventDefault(); document.execCommand("insertHTML", false, blk.html); editor.focus(); sync(); dropdown.style.display = "none"; };
      dropdown.appendChild(item);
    });
    blocksContainer.appendChild(dropdown);
    blocksBtn.onclick = function(e) { e.preventDefault(); dropdown.style.display = dropdown.style.display === "none" ? "block" : "none"; };
    document.addEventListener("click", function(e) { if (!blocksContainer.contains(e.target)) dropdown.style.display = "none"; });
