...
export default function KooperativPodKlyuchPage() {
    ...
    <main style={{ paddingTop: "5rem", minHeight: "60vh", background: "var(--color-bg-950, #0D0C0A)" }}>
      ...
      <section style={{
        ...
        <h1 style={{
          ...
          Кооператив под ключ —<br />
          <span style={{ color: "#B8956A" }}>законно, без рисков, за 25 дней</span>
        </h1>
        <p style={{
          fontSize: "1.15rem",
        ...
        <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
          <Link href="#cta" className="btn-primary" style={{ display: "inline-block", padding: "0.9rem 2rem", fontSize: "1rem", textDecoration: "none" }}>
      ...
      <section style={{ padding: "3rem 1.5rem", maxWidth: 1200, margin: "0 auto" }}>
        <h2 style={{ textAlign: "center", fontSize: "clamp(1.5rem, 3vw, 2rem)", color: "#E7DCCF", marginBottom: "2.5rem", fontWeight: 700 }}>
          Что вы получаете
        </h2>
      ...
      <section style={{ padding: "3rem 1.5rem", maxWidth: 900, margin: "0 auto" }}>
        <h2 style={{ textAlign: "center", fontSize: "clamp(1.5rem, 3vw, 2rem)", color: "#E7DCCF", marginBottom: "2rem", fontWeight: 700 }}>
          Какие проблемы решает кооператив
        </h2>
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          {[
            ...
            <div key={i} style={{
              ...
              gap: "1rem",
              padding: "1.5rem",
              background: "rgba(214,198,178,0.02)",
              borderRadius: 12,
      ...
      <section style={{ padding: "3rem 1.5rem", maxWidth: 800, margin: "0 auto" }}>
        <h2 style={{ textAlign: "center", fontSize: "clamp(1.5rem, 3vw, 2rem)", color: "#E7DCCF", marginBottom: "2rem", fontWeight: 700 }}>
          Кооператив или ООО — что выгоднее
        </h2>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", minWidth: 500 }}>
            ...
            <tbody>
              {[
                ...
                ["НДФЛ с распределения", "13%", "0%"],
                ["Ответственность", "Всем имуществом", "Ограничена паём"],
                ["Защита активов", "Нет", "Неделимый фонд"],
                ["Срок создания", "3–5 дней", "25 дней"],
              ].map((row, i) => (
                <tr key={i}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(340px, 1fr))", gap: "1.5rem" }}>
          ...
          <div style={{
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: "0 0 1.5rem", color: "rgba(214,198,178,0.8)", fontSize: "0.9rem", lineHeight: 2 }}>
              <li>✓ Устав по шаблону (адаптированный)</li>
              <li>✓ Протокол №1 + Р11001</li>
              <li>✓ 13 Положений по шаблону</li>
              <li>✓ Базовая ЦПП</li>
              <li>✓ 10 образцов документов</li>
            </ul>
          </div>
          {/* Персонифицированный */}
          <div style={{
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: "0 0 1.5rem", color: "rgba(214,198,178,0.8)", fontSize: "0.9rem", lineHeight: 2 }}>
              <li>✓ Индивидуальный Устав (с нуля)</li>
              <li>✓ Протокол №1 + Р11001</li>
              <li>✓ 13 Положений (индивидуальных)</li>
              <li>✓ 2 Целевые потребительские программы</li>
              <li>✓ 10 образцов документов</li>
              <li>✓ 2 месяца консалтинга</li>
              <li>✓ Приоритетная обработка (5 дней)</li>
            </ul>
          </div>
        </div>
        <p style={{ textAlign: "center", color: "rgba(214,198,178,0.5)", fontSize: "0.85rem", marginTop: "1.5rem" }}>
          Для сравнения: налоговая экономия кооператива с оборотом 10 млн ₽/мес — около 2 млн ₽/мес. Стоимость пакета окупается за первую неделю.
        </p>
      </section>

      {/* ═══ OBJECTIONS (аккордеон) ═══ */}
      <section style={{ padding: "3rem 1.5rem", maxWidth: 800, margin: "0 auto" }}>
        <h2 style={{ textAlign: "center", fontSize: "clamp(1.5rem, 3vw, 2rem)", color: "#E7DCCF", marginBottom: "2rem", fontWeight: 700 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
          {objections.map((item, i) => (
            <div key={i} style={{
              ...
              >
                {item.q}
                <span style={{ color: "#B8956A", fontSize: "1.2rem", transition: "transform 0.2s", transform: openObjection === i ? "rotate(45deg)" : "none" }}>+</span>
              </button>
              {openObjection === i && (
                <div style={{ padding: "0 1.25rem 1rem", color: "rgba(214,198,178,0.7)", fontSize: "0.9rem", lineHeight: 1.6 }}>
                  {item.a}
                </div>
              )}
            </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
          {faqItems.map((item, i) => (
            <div key={i} style={{
              ...
              >
                {item.q}
                <span style={{ color: "#B8956A", fontSize: "1.2rem", transition: "transform 0.2s", transform: openFaq === i ? "rotate(45deg)" : "none" }}>+</span>
              </button>
              {openFaq === i && (
                <div style={{ padding: "0 1.25rem 1rem", color: "rgba(214,198,178,0.7)", fontSize: "0.9rem", lineHeight: 1.6 }}>
                  {item.a}
      ...
      <section id="cta" style={{ padding: "3rem 1.5rem 5rem", maxWidth: 700, margin: "0 auto", textAlign: "center" }}>
        <div style={{
          ...
          <h2 style={{ color: "#E7DCCF", fontSize: "1.5rem", fontWeight: 700, marginBottom: "0.75rem" }}>
            Готовы начать?
          </h2>
          <p style={{ color: "rgba(214,198,178,0.7)", fontSize: "1rem", marginBottom: "1.5rem" }}>
            Запишитесь на бесплатную консультацию — отвечу на все вопросы и помогу определить, подходит ли вам кооператив.
          </p>
          <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
            <a href="tel:+79024720738" className="btn-primary" style={{ display: "inline-block", padding: "0.85rem 2rem", fontSize: "1rem", textDecoration: "none" }}>
              📞 +7 (902) 472-07-38
            </a>
            <a href="https://t.me/Veles_ST" target="_blank" rel="noopener" style={{
              display: "inline-block",
          ...
          <p style={{ color: "rgba(214,198,178,0.4)", fontSize: "0.8rem", marginTop: "1.5rem" }}>
            Велеслав Старков · 120+ ПК с 2015 года · Закон РФ № 3085-1
          </p>
        </div>
      </section>
    </main>
