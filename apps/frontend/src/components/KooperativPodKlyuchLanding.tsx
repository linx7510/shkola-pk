...
// ============================================================
const keyTakeaways = [
  "Кооператив под ключ — это услуга создания потребительского кооператива (ПК) под регистрацию в ФНС: индивидуальный Устав редакции 27-5, 16 Положений, более 100 рабочих документов, 2 ЦПП.",
  ...
  "Срок создания: 15–25 рабочих дней в зависимости от тарифа (разработка документов + 3 дня регистрация в ФНС + резерв).",
...
const faqItems: FAQItem[] = [
  { q: "Что такое кооператив под ключ?", a: "Кооператив под ключ — это комплексная услуга, при которой исполнитель берёт на себя весь цикл создания потребительского кооператива: от сбора первичных данных до получения листа записи ЕГРЮЛ. Вы получаете индивидуальный Устав редакции 27-5, 16 Положений, более 100 рабочих документов (заявления, протоколы, акты, журналы, чек-листы), 2 Целевые потребительские программы." },
  ...
  { q: "Сколько стоит кооператив под ключ?", a: "Тариф «Базовый» — 90 000 ₽ (12 Положений, 1 месяц консалтинга, 25 рабочих дней). Тариф «Персонифицированный» — 125 000 ₽ (16 Положений + 100+ рабочих документов, 15 рабочих дней, 2 месяца консалтинга). Госпошлина при электронной подаче — 0 ₽. Для сравнения: налоговая экономия ПК с оборотом 10 млн ₽/мес — около 2 млн ₽/мес. Пакет окупается за 1 неделю." },
  ...
  { q: "Чем отличается тариф «Базовый» от «Персонифицированного»?", a: "«Базовый» (90 000 ₽) — Устав по шаблону (адаптированный под ваш бизнес), 12 Положений (без Положений о конфликте интересов, ПОД/ФТ, крупных сделках и защите ПДн), 1 месяц консалтинга, 25 рабочих дней. «Персонифицированный» (125 000 ₽) — индивидуальный Устав редакции 27-5 с нуля, 16 Положений + полный комплект 100+ рабочих документов, 2 Целевые потребительские программы, 2 месяца консалтинга, 15 рабочих дней, приоритетная обработка." },
...
const caseStudies = [
  {
    ...
    timeline: "22 дня",
    documents: "16 Положений + 100+ рабочих документов"
  },
  {
    ...
    timeline: "25 дней",
    documents: "16 Положений + 3 доп. + 100+ рабочих документов"
  },
  {
    industry: "Услуги",
    ...
    timeline: "18 дней",
    documents: "12 Положений (базовый набор)"
  },
];
...
// ============================================================
const paaQuestions = [
  { q: "Сколько стоит создать кооператив?", a: "От 90 000 ₽ (Базовый тариф, 12 Положений, 1 месяц консалтинга) до 125 000 ₽ (Персонифицированный, 16 Положений + 100+ рабочих документов + консалтинг, 15 рабочих дней). Госпошлина при электронной регистрации — 0 ₽." },
  { q: "Сколько времени регистрируется кооператив?", a: "Зависит от тарифа: Базовый — 25 рабочих дней, Персонифицированный — 15 рабочих дней. Плюс 3 дня регистрация в ФНС. Это дольше ООО (3–5 дней) из-за большего объёма документов." },
  { q: "Какие документы нужны для кооператива?", a: "Индивидуальный Устав редакции 27-5, Протокол №1, Заявление Р11001, 16 Положений, более 100 рабочих документов (заявления, протоколы, акты, журналы, чек-листы), 2 Целевые потребительские программы, реестр пайщиков." },
...
const benefits = [
  ...
  { icon: "📋", title: "От 12 до 16 Положений + 100+ документов", desc: "Индивидуальный Устав 27-5, 12–16 Положений, до 100+ рабочих форм, 2 ЦПП. Полный пакет за 15–25 дней." },
...
const steps = [
  ...
  { num: "4", title: "Положения + ЦПП", days: "день 12–20", desc: "16 Положений и 2 Целевые потребительские программы с полным комплектом рабочих документов. Детализация всех аспектов." },
...
<h2 id="dokumenty">Какие документы нужны для кооператива — 16 Положений и 100+ рабочих документов</h2>
<p>Пакет включает:</p>
...
<p>Тариф «Базовый» (90 000 ₽) — 12 Положений (без Положений о конфликте интересов, ПОД/ФТ, крупных сделках и защите ПДн), Устав по шаблону, 1 месяц консалтинга, 25 рабочих дней. Тариф «Персонифицированный» (125 000 ₽) — 16 Положений + 100+ рабочих документов, индивидуальный Устав редакции 27-5, 2 ЦПП, 2 месяца консалтинга, 15 рабочих дней.</p>
      ...
      "@graph": [
        {
          ...
          "description": "Комплексная услуга создания потребительского кооператива: индивидуальный Устав редакции 27-5, 16 Положений, 100+ рабочих документов, регистрация в ФНС, 2 месяца консалтинга. От 90 000 ₽, 25 дней.",
          "provider": {
            "@type": "Organization",
          ...
          "offers": [
            {
              ...
              "price": "90000",
              "priceCurrency": "RUB",
              "description": "12 Положений (без конфликта интересов, ПОД/ФТ, крупных сделках и защиты ПДн), Устав по шаблону, 1 месяц консалтинга, 25 рабочих дней"
            },
            {
              "@type": "Offer",
              ...
              "price": "125000",
              "priceCurrency": "RUB",
              "description": "16 Положений + 100+ рабочих документов, индивидуальный Устав редакции 27-5, 2 ЦПП, 2 месяца консалтинга, 15 рабочих дней"
            }
          ],
    ...
    <main style={{ paddingTop: "0", minHeight: "60vh", background: "var(--color-bg-950, #0D0C0A)" }}>
      ...
      <section style={{ padding: "3rem 1.5rem 2rem", textAlign: "center", maxWidth: 1200, margin: "0 auto" }}>
        ...
        <p style={{ fontSize: "1.15rem", color: "rgba(214,198,178,0.8)", maxWidth: 700, margin: "0 auto 1rem", lineHeight: 1.6 }}>
          16 Положений + 100+ рабочих документов. Устав редакции 27-5, Целевые программы. 0% НДС, 0% налог на прибыль. 120+ ПК создано с 2015 года. Ни один не ликвидирован ФНС.
        </p>
        ...
        <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
          <Link href="#cta" prefetch={false} className="btn-primary" style={{ display: "inline-block", padding: "0.9rem 2rem", fontSize: "1rem", textDecoration: "none" }}>Получить консультацию</Link>
      ...
      <section style={{ padding: "1.5rem 1.5rem", maxWidth: 1200, margin: "0 auto" }}>
        <nav style={{ background: "rgba(214,198,178,0.03)", borderRadius: 12, padding: "1.25rem 1.5rem", border: "1px solid rgba(214,198,178,0.08)" }}>
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: "0.4rem" }}>
            ...
            <li><a href="#dokumenty" style={{ color: "rgba(214,198,178,0.8)", textDecoration: "none", fontSize: "1.05rem" }}>Документы (16 + 100)</a></li>
      ...
      <section style={{ padding: "2rem 1.5rem", maxWidth: 1200, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          {[
            ...
            { pain: "Не знаете, с чего начать — 100+ документов", solution: "5 этапов от заявки до ЕГРЮЛ. Вы получаете готовый пакет: Устав 27-5, 16 Положений и 100+ рабочих документов" },
      ...
      <section style={{ padding: "2rem 1.5rem", maxWidth: 1300, margin: "0 auto" }}>
        <div style={{ display: "flex", gap: "2rem", alignItems: "center", marginBottom: "2.5rem", flexWrap: "wrap" }}>
          <div style={{ flex: "1 1 400px" }}>
            ...
            <p style={{ color: "rgba(214,198,178,0.75)", fontSize: "1rem", lineHeight: 1.5 }}>От первого звонка до записи в ЕГРЮЛ — 15–25 рабочих дней в зависимости от тарифа</p>
          </div>
          <div style={{ flex: "0 0 300px", display: "flex", justifyContent: "center" }}>
            <img 
      ...
      <section id="pricing" style={{ padding: "2rem 1.5rem", maxWidth: 1300, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(340px, 1fr))", gap: "1.5rem" }}>
          <div style={{ padding: "2rem", background: "rgba(214,198,178,0.03)", borderRadius: 14, border: "1px solid rgba(214,198,178,0.1)" }}>
            ...
            <p style={{ color: "rgba(214,198,178,0.8)", fontSize: "1.05rem", marginBottom: "1.5rem" }}>12 Положений · 1 месяц консалтинга · 25 рабочих дней</p>
            <ul style={{ listStyle: "none", padding: 0, margin: "0 0 1.5rem", color: "rgba(214,198,178,0.8)", fontSize: "1rem", lineHeight: 2 }}>
              <li>✓ Устав по шаблону (адаптированный)</li><li>✓ Протокол №1 + Р11001</li><li>✓ 12 Положений (без конфликта интересов, ПОД/ФТ, крупных сделках и защиты ПДн)</li><li>✓ Базовая ЦПП</li><li>✓ Ключевые рабочие формы</li><li>✓ 1 месяц консалтинга</li>
            </ul>
          </div>
          <div style={{ padding: "2rem", background: "rgba(184,149,106,0.08)", borderRadius: 14, border: "2px solid rgba(184,149,106,0.3)", position: "relative" }}>
            ...
            <p style={{ color: "rgba(214,198,178,0.8)", fontSize: "1.05rem", marginBottom: "1.5rem" }}>16 Положений + 100+ рабочих документов · 15 рабочих дней</p>
            <ul style={{ listStyle: "none", padding: 0, margin: "0 0 1.5rem", color: "rgba(214,198,178,0.8)", fontSize: "1rem", lineHeight: 2 }}>
              <li>✓ Индивидуальный Устав редакции 27-5 (с нуля)</li><li>✓ Протокол №1 + Р11001</li><li>✓ 16 Положений (индивидуальных)</li><li>✓ 2 Целевые потребительские программы</li><li>✓ 100+ рабочих документов (формы, журналы, акты)</li><li>✓ 2 месяца консалтинга</li><li>✓ Приоритетная обработка (5 дней)</li>
            </ul>
          </div>
        </div>
      ...
      <section style={{ padding: "2rem 1.5rem", maxWidth: 1200, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: "1rem" }}>
          {relatedArticles.map((article, i) => (
            <Link key={i} href={article.href} prefetch={false} style={{ display: "block", padding: "1.25rem", background: "rgba(214,198,178,0.03)", borderRadius: 10, border: "1px solid rgba(214,198,178,0.08)", color: "#D6C6B2", textDecoration: "none", fontSize: "1rem", lineHeight: 1.4, transition: "all 0.2s" }}
