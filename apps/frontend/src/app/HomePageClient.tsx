          ...
          <Reveal delay={2}>
            <div style={{display:"flex", flexWrap:"wrap", gap:"0.6rem", justifyContent:"center", maxWidth:900, margin:"0 auto"}}>
              {([
                ...
                {label:"Целевые программы (ЦПП)", href:"/uslugi-dlya-potrebitelskih-kooperativov/celevie-potrebitelskie-programmy", size:1.2, color:"#B8956A"},
                {label:"Разработка Положений для ПК", href:"/uslugi-dlya-potrebitelskih-kooperativov/sozdanie-polnogo-komplekta-polozheniy", size:1.05, color:"#B8956A"},
                {label:"ЦПП: защита от налоговой (гид)", href:"/blog/celevie-potrebitelskie-programmy-pk", size:1.1, color:"#E68863"},
                {label:"Курс «Старт» — бесплатно", href:"/kursy-obuchenie-potrebitelskoy-kooperatsii-onlayn", size:1.0, color:"#6DB89A"},
