...
export function middleware(request: NextRequest) {
  ...
  const cspEnforced = [
    `default-src 'self'`,
    `script-src 'nonce-${nonce}' 'strict-dynamic' 'unsafe-inline' 'unsafe-eval' https://mc.yandex.ru https://yandex.ru https://challenges.cloudflare.com https://smartcaptcha.yandexcloud.com`,
  ...
  const cspReportOnly = [
    `default-src 'self'`,
    `script-src 'nonce-${nonce}' 'strict-dynamic' 'unsafe-inline' https://mc.yandex.ru https://yandex.ru https://challenges.cloudflare.com https://smartcaptcha.yandexcloud.com`,
    `style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://challenges.cloudflare.com https://smartcaptcha.yandexcloud.com`,
    `font-src 'self' data:`,
    `img-src 'self' data: https: blob:`,
    `connect-src 'self' https://api.deepseek.com https://mc.yandex.ru https://yandex.ru wss://mc.yandex.ru https://challenges.cloudflare.com https://smartcaptcha.yandexcloud.com`,
