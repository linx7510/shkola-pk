...
function LatestBlogPosts() {
  ...
  useEffect(() => {
    const PAYLOAD_API_URL = process.env.NEXT_PUBLIC_PAYLOAD_URL || "https://2980738.ru";
    ...
    <>
      ...
      <section id="about-veleslav" style={{...S, background:"rgba(214,198,178,0.02)"}}>
        <div style={{...I, maxWidth:1000}}>
          ...
          <div style={{display:"grid", gridTemplateColumns:"minmax(280px, 360px) 1fr", gap:"3rem", alignItems:"center"}}>
            <Reveal>
      ...
      {/* ===== LATEST BLOG POSTS ===== */}
      <section id="latest-materials" style={S}>
        <div style={I}>
          <Reveal>
            <div style={{textAlign:"center", marginBottom:"2.5rem"}}>
          ...
          <Reveal>
            <div style={{maxWidth:800, margin:"0 auto", textAlign:"center", padding:"2rem"}}>
              ...
              <p style={{color:"rgba(214,198,178,0.97)", fontSize:"1.1rem", lineHeight:1.8, marginTop:"1.5rem", marginBottom:"2rem"}}>
                ...
                Полный курс: 4 пакета обучения, 64 часа практики, 12 месяцев поддержки.
              </p>
              <div style={{display:"flex", gap:"1rem", justifyContent:"center", flexWrap:"wrap"}}>
                <Link href="/kursy" className="btn-primary" style={{padding:"0.85rem 2rem", fontSize:"1rem", textDecoration:"none"}}>Выбрать курс</Link>
                <Link href="/konsultacii" className="btn-secondary" style={{padding:"0.85rem 2rem", fontSize:"1rem", textDecoration:"none"}}>Бесплатная консультация</Link>
              </div>
            </div>
          </Reveal>
        </div>
      ...
      <section className="cta reveal">
        <div style={I}>
          <div style={{textAlign:"center",maxWidth:550,margin:"0 auto"}}>
            ...
            <p style={{color:"rgba(214,198,178,0.88)",marginBottom:"2rem",lineHeight:1.7}}>Запишитесь на бесплатную консультацию — разберём вашу ситуацию и подберём оптимальный формат</p>
          ...
          <div style={{display:"flex", flexDirection:"column", gap:"1.25rem"}}>
            ...
            <Reveal>
              <div style={{padding:"1.5rem", background:"rgba(214,198,178,0.04)", border:"1px solid rgba(214,198,178,0.12)", borderRadius:12}}>
                <h3 style={{fontSize:"1.1rem", fontWeight:600, color:"#E7DCCF", marginBottom:"0.75rem"}}>Что такое потребительский кооператив и чем он отличается от ООО?</h3>
            ...
            <Reveal>
              <div style={{padding:"1.5rem", background:"rgba(214,198,178,0.04)", border:"1px solid rgba(214,198,178,0.12)", borderRadius:12}}>
                <h3 style={{fontSize:"1.1rem", fontWeight:600, color:"#E7DCCF", marginBottom:"0.75rem"}}>Сколько времени занимает создание ПК под ключ?</h3>
                <p style={{fontSize:"0.92rem", color:"rgba(214,198,178,0.85)", lineHeight:1.8}}>
            ...
            <Reveal>
              <div style={{padding:"1.5rem", background:"rgba(214,198,178,0.04)", border:"1px solid rgba(214,198,178,0.12)", borderRadius:12}}>
                <h3 style={{fontSize:"1.1rem", fontWeight:600, color:"#E7DCCF", marginBottom:"0.75rem"}}>Какие налоги платит потребительский кооператив?</h3>
                <p style={{fontSize:"0.92rem", color:"rgba(214,198,178,0.85)", lineHeight:1.8}}>
            ...
            <Reveal>
              <div style={{padding:"1.5rem", background:"rgba(214,198,178,0.04)", border:"1px solid rgba(214,198,178,0.12)", borderRadius:12}}>
                <h3 style={{fontSize:"1.1rem", fontWeight:600, color:"#E7DCCF", marginBottom:"0.75rem"}}>Кто может стать пайщиком потребительского кооператива?</h3>
                <p style={{fontSize:"0.92rem", color:"rgba(214,198,178,0.85)", lineHeight:1.8}}>
            ...
            <Reveal>
              <div style={{padding:"1.5rem", background:"rgba(214,198,178,0.04)", border:"1px solid rgba(214,198,178,0.12)", borderRadius:12}}>
                <h3 style={{fontSize:"1.1rem", fontWeight:600, color:"#E7DCCF", marginBottom:"0.75rem"}}>Как защитить имущество через паевую модель?</h3>
                <p style={{fontSize:"0.92rem", color:"rgba(214,198,178,0.85)", lineHeight:1.8}}>
            ...
            <Reveal>
              <div style={{padding:"1.5rem", background:"rgba(214,198,178,0.04)", border:"1px solid rgba(214,198,178,0.12)", borderRadius:12}}>
                <h3 style={{fontSize:"1.1rem", fontWeight:600, color:"#E7DCCF", marginBottom:"0.75rem"}}>В чём заключается модель С500 и почему она эффективна?</h3>
                <p style={{fontSize:"0.92rem", color:"rgba(214,198,178,0.85)", lineHeight:1.8}}>
            ...
            <Reveal>
              <div style={{padding:"1.5rem", background:"rgba(214,198,178,0.04)", border:"1px solid rgba(214,198,178,0.12)", borderRadius:12}}>
                <h3 style={{fontSize:"1.1rem", fontWeight:600, color:"#E7DCCF", marginBottom:"0.75rem"}}>Как проходит обучение в Школе и что получает ученик по итогу?</h3>
                <p style={{fontSize:"0.92rem", color:"rgba(214,198,178,0.85)", lineHeight:1.8}}>
      ...
      <footer className="site-footer">
        <div style={I}>
          <div style={{display:"grid", gridTemplateColumns:"repeat(auto-fit, minmax(200px, 1fr))", gap:"2rem", padding:"3rem 0 2rem"}}>
            {/* Колонка 1 — О школе */}
            <div>
              <div style={{fontWeight:700, color:"#E7DCCF", marginBottom:"1rem", fontSize:"0.95rem"}}>Школа Кооперативов</div>
              <p style={{fontSize:"0.85rem", color:"rgba(214,198,178,0.9)", lineHeight:1.7, marginBottom:"1rem"}}>
                Первая онлайн Школа потребительской кооперации — обучение, консалтинг и юридическое сопровождение с 2015 года.
                Более 120 предпринимателей открыли свои ПК с нашей помощью.
              </p>
              <div style={{fontSize:"0.8rem", color:"rgba(214,198,178,0.78)"}}>
                ИП Старков Велеслав Владимирович<br/>ИНН 590415054646
              </div>
            </div>
            {/* Колонка 2 — Навигация */}
            <div>
              ...
              <div style={{display:"flex", flexDirection:"column", gap:"0.5rem"}}>
                ...
                <Link href="/besplatno" style={{fontSize:"0.85rem", color:"rgba(214,198,178,0.9)", textDecoration:"none"}}>Бесплатно</Link>
                <Link href="/about" style={{fontSize:"0.85rem", color:"rgba(214,198,178,0.9)", textDecoration:"none"}}>О нас</Link>
              </div>
            </div>
            {/* Колонка 3 — Контакты */}
            <div>
              <div style={{fontWeight:600, color:"#E7DCCF", marginBottom:"1rem", fontSize:"0.9rem"}}>Контакты</div>
              <div style={{display:"flex", flexDirection:"column", gap:"0.5rem"}}>
                <a href="tel:+79024720738" style={{fontSize:"0.85rem", color:"rgba(214,198,178,0.9)", textDecoration:"none"}}>+7 (902) 472-07-38</a>
                <a href="mailto:boss@2980738.ru" style={{fontSize:"0.85rem", color:"rgba(214,198,178,0.9)", textDecoration:"none"}}>boss@2980738.ru</a>
                <a href="https://t.me/Veles_ST" target="_blank" style={{fontSize:"0.85rem", color:"rgba(214,198,178,0.9)", textDecoration:"none"}}>Telegram: @Veles_ST</a>
                <a href="https://t.me/OnlinePK" target="_blank" style={{fontSize:"0.85rem", color:"rgba(214,198,178,0.9)", textDecoration:"none"}}>Группа ПК: @OnlinePK</a>
                <div style={{fontSize:"0.8rem", color:"rgba(214,198,178,0.78)", marginTop:"0.5rem"}}>г. Пермь, ул. Фонтанная, д. 1а/1</div>
              </div>
            </div>
            {/* Колонка 4 — Юридическое */}
            <div>
              <div style={{fontWeight:600, color:"#E7DCCF", marginBottom:"1rem", fontSize:"0.9rem"}}>Юридическое</div>
              <div style={{display:"flex", flexDirection:"column", gap:"0.5rem"}}>
                <Link href="/privacy" style={{fontSize:"0.85rem", color:"rgba(214,198,178,0.9)", textDecoration:"none"}}>Политика конфиденциальности</Link>
                <Link href="/terms" style={{fontSize:"0.85rem", color:"rgba(214,198,178,0.9)", textDecoration:"none"}}>Оферта</Link>
                <Link href="/consent" style={{fontSize:"0.85rem", color:"rgba(214,198,178,0.9)", textDecoration:"none"}}>Согласие на обработку ПДн</Link>
                <div style={{fontSize:"0.8rem", color:"rgba(214,198,178,0.78)", marginTop:"0.5rem"}}>
                  Закон РФ № 3085-1<br/>
                  от 19.06.1992 (ред. 2026)
                </div>
              </div>
            </div>
          </div>
          <div style={{borderTop:"1px solid rgba(214,198,178,0.1)", paddingTop:"1.5rem", paddingBottom:"1.5rem", display:"flex", justifyContent:"space-between", alignItems:"center", flexWrap:"wrap", gap:"1rem"}}>
            <div style={{fontSize:"0.8rem", color:"rgba(214,198,178,0.78)"}}>
              © ИП Старков Велеслав Владимирович, 2015–2026
            </div>
            <div style={{fontSize:"0.75rem", color:"rgba(214,198,178,0.3)"}}>
              Платформа v5.4 · Фаза 1 — Platform Kernel
            </div>
          </div>
        </div>
      </footer>
