            ...
            <div style={{maxWidth:800, margin:"0 auto", textAlign:"center", padding:"2rem"}}>
              ...
              <div style={{display:"grid", gridTemplateColumns:"repeat(3, 1fr)", gap:"1.5rem", marginTop:"2rem", marginBottom:"2rem"}}>
                ...
                <div style={{padding:"1.5rem", background:"rgba(214,198,178,0.05)", border:"1px solid rgba(214,198,178,0.12)", borderRadius:14, textAlign:"center"}}>
                  ...
                  <h3 style={{fontSize:"1.1rem", color:"#E7DCCF", marginBottom:"0.5rem"}}>Консультации</h3>
                  <p style={{fontSize:"0.88rem", color:"rgba(214,198,178,0.85)", marginBottom:"0.75rem"}}>Индивидуально или группой. Онлайн. 1 час — 6 000 ₽</p>
                  <Link href="/konsultacii" style={{display:"inline-block", padding:"0.5rem 1.25rem", background:"#E68863", color:"#fff", borderRadius:8, fontSize:"0.88rem", textDecoration:"none", fontWeight:600}}>Записаться</Link>
                </div>
                {/* Бесплатные видео-уроки */}
                <div style={{padding:"1.5rem", background:"rgba(214,198,178,0.05)", border:"1px solid rgba(214,198,178,0.12)", borderRadius:14, textAlign:"center"}}>
                  <div style={{fontSize:"2.5rem", marginBottom:"0.5rem"}}>🎬</div>
                  <h3 style={{fontSize:"1.1rem", color:"#E7DCCF", marginBottom:"0.5rem"}}>Бесплатные видео-уроки</h3>
                  <p style={{fontSize:"0.88rem", color:"rgba(214,198,178,0.85)", marginBottom:"0.75rem"}}>13 базовых уроков. Понимание основ. Доступ сразу после регистрации</p>
                  <Link href="/besplatno" style={{display:"inline-block", padding:"0.5rem 1.25rem", background:"rgba(214,198,178,0.15)", color:"#E7DCCF", borderRadius:8, fontSize:"0.88rem", textDecoration:"none", fontWeight:600, border:"1px solid rgba(214,198,178,0.2)"}}>Смотреть</Link>
                </div>
                {/* Обучающий курс */}
                <div style={{padding:"1.5rem", background:"rgba(230,136,99,0.08)", border:"2px solid rgba(230,136,99,0.3)", borderRadius:14, textAlign:"center", position:"relative"}}>
                  <div style={{position:"absolute", top:-10, left:"50%", transform:"translateX(-50%)", background:"#E68863", color:"#fff", padding:"0.2rem 0.75rem", borderRadius:10, fontSize:"0.72rem", fontWeight:600}}>ПОПУЛЯРНОЕ</div>
                  <div style={{fontSize:"2.5rem", marginBottom:"0.5rem"}}>🎓</div>
